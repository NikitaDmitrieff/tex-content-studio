...
const DEMO_CHARACTERS: CharacterWithStats[] = [
  ...
  },
  {
    ...
    name: 'Dave Kowalski',
    age: 58,
    job: 'Factory floor supervisor',
    backstory: 'Dave has worked the same factory for 30 years. Bad knees, bad back, and a doctor telling him his cholesterol is a problem.',
    physical_description: 'Stocky, late 50s, gray buzz cut, pale complexion, always in a Carhartt jacket',
    visual_dna: 'same stocky man, late 50s, gray buzz cut, pale complexion, Carhartt work jacket, no-nonsense expression, harsh industrial lighting, candid smartphone photo quality',
